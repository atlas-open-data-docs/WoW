...
<h>
  <head>
    ...
    <title>ATLAS Open Data Tree</title>
...
<hr>
  <body>
    ...
    function update(source) {
      ...
      .attr("x", function(d) { return d.children || d._children ? -54 : 48; })
      .attr("dy", ".35em")
      ...
      .attr("y", -8)
      .attr("x", function (d) { return d.children || d._children ? -158 : 138; })
      .attr("width", 21) //2*4.5)
      .attr("height", 21)
      .style("fill", "steelblue") // "lightsteelblue")
